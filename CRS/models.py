...
class FacultyInfo(models.Model):
    ...
    facultyCitizenship = models.CharField(max_length=50, null=True, choices=Citizenship_CHOICES,
...
class BlockSection(models.Model):
    ...
    def __str__(self):
       return '%s %s' %(self.blockYear, self.blockSection)
...
class curriculumInfo(models.Model):
    ...
    schoolYear = models.CharField(max_length=100, verbose_name="School Year", null=True)
    schoolSem = models.CharField(max_length=100, verbose_name="School Sem", null=True)
...
class StudentInfo(models.Model):
    ...
    studentCitizenship = models.CharField(max_length=50, null=True, choices=Citizenship_CHOICES,
                                          verbose_name='Citizenship')
...
class studentScheduling(models.Model):
    ...
    test=models.CharField(max_length=100, null=True, verbose_name='Room')
...
#Database structures for study plan generation brrt brrt
class Curricula(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['departmentID', 'cYear', 'cSem'], name='unique_curriculum')
        ]

    def __str__(self):
        return '%s - %s, %s' %(self.departmentID, self.cYear, self.cSem)
...
class studyPlan(models.Model):
    ...
    #curricula = models.ForeignKey(Curricula, verbose_name='Dept & Sem', null=True, blank=True, on_delete=models.PROTECT)
    curricula = models.ForeignKey(Curricula, verbose_name='Dept & Sem', null=True, blank=True, on_delete=models.PROTECT)
